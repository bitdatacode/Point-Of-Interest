    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('provinces_id') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $group->has('province') ? $this->Html->link($group->province->name, ['controller' => 'Provinces', 'action' => 'view', $group->province->id]) : '' ?></td>
                <td class="actions">
